...
## Corpus Check
- 82 files · ~2,494,329 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1273 nodes · 1541 edges · 88 communities (67 shown, 13 thin omitted)
...
Cohesion: 0.04
Nodes (49): deleted_data_screen.dart, _ActiveFilterItem, _allCards, _allCefrLevels, _allUniqueTypes, _applyFilterAndSort, _cardOriginalNumbers, _cefrSortAscending (+41 more)
...
Cohesion: 0.05
Nodes (44): dart:async, Duration, GlobalKey, actionLabel, _animateDismiss, _animController, AppNotification, _autoDismissTimer (+36 more)
...
Cohesion: 0.18
Nodes (10): dart:io, package:flutter_test/flutter_test.dart, package:yor_flashcard/models/deck.dart, package:yor_flashcard/models/flashcard_card.dart, package:yor_flashcard/services/excel_service.dart, package:yor_flashcard/services/prompt_service.dart, main, main (+2 more)

### Community 9 - "import_mapping_dialog.dart"
Cohesion: 0.14
Nodes (14): build, createState, _getPreviewText, ImportMappingDialog, _ImportMappingDialogState, initState, metadata, _numFlashcardColumns (+6 more)
...
Cohesion: 0.08
Nodes (24): Animation, AnimationController, dart:math, _animationController, _buildExtraColumnsLayout, _buildScoreAndPracticeAction, _buildScoreBadge, _checkAnswer (+16 more)

### Community 12 - "deleted_data_screen.dart"
Cohesion: 0.08
Nodes (24): build, _buildDataTableCard, _buildPaginationControls, _cardOriginalNumbers, columnHeaders, _createDataRow, createState, _currentPage (+16 more)

### Community 13 - "deck_config.dart"
Cohesion: 0.10
Nodes (19): bool?, cefrSortAscending, copyWith, DeckConfig, deckId, fromJson, orderMode, rangeEnd (+11 more)
...
Cohesion: 0.12
Nodes (16): DeckProvider, build, didChangeDependencies, _handleRestoreCard, _showEditCardDialog, _importDataset, initState, _showDeleteDialog (+8 more)

### Community 17 - "result_screen.dart"
Cohesion: 0.11
Nodes (20): ChangeNotifier, Color?, deck_detail_screen.dart, home_screen.dart, IconData?, YorFlashCardApp, LearningSessionProvider, build (+12 more)
...
Cohesion: 0.12
Nodes (18): LanguageProvider, _handleSave, _buildActionButtons, _buildDataPreviewTable, _buildFilterAndSortHeader, _buildPaginationControls, _confirmDelete, _copyPrompt (+10 more)
...
Cohesion: 0.01
Nodes (160): activeDataset, activeFilter, addCustomCard, addNewWords, addRow, applyFilter, applyRange, applySort (+152 more)
...
### Community 42 - "State"
Cohesion: 0.20
Nodes (14): _AddCustomCardDialog, _AddCustomCardDialogState, DeckDetailScreen, _DeckDetailScreenState, _WritingPracticeDialog, _WritingPracticeDialogState, _ExportDeckWidget, _ExportDeckWidgetState (+6 more)
...
Cohesion: 0.40
Nodes (4): package:shared_preferences/shared_preferences.dart, package:yor_flashcard/providers/language_provider.dart, package:yor_flashcard/utils/app_strings.dart, main
...
### Community 85 - "writing_practice_test.dart"
Cohesion: 0.33
Nodes (5): return, main, trimmedExpected, trimmedInput, verifyWritingPracticeAnswer
...
## Knowledge Gaps
- **914 isolated node(s):** `themeProvider`, `languageProvider`, `main`, `loadTheme`, `loadLanguage` (+909 more)
...
- **Why does `LanguageProvider` connect `LanguageProvider` to `learning_preview_screen.dart`, `language_provider.dart`, `deck_detail_screen.dart`, `home_screen.dart`, `import_mapping_dialog.dart`, `State`, `flashcard_screen.dart`, `deleted_data_screen.dart`, `export_mapping_dialog.dart`, `DeckProvider`, `result_screen.dart`, `main.dart`, `ThemeProvider`, `_startLearning`, `import_preview_screen.dart`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `DeckProvider` connect `DeckProvider` to `learning_preview_screen.dart`, `app_providers.dart`, `home_screen.dart`, `deck_detail_screen.dart`, `State`, `flashcard_screen.dart`, `deleted_data_screen.dart`, `result_screen.dart`, `ThemeProvider`, `LanguageProvider`, `_startLearning`?**
